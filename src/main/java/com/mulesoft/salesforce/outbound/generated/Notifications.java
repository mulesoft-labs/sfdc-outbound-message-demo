 ...
 *         &lt;element name="Notification" type="{http://soap.sforce.com/2005/09/outbound}OpportunityNotification" maxOccurs="100"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Notifications {
    ...
    protected List<OpportunityNotification> notification;
     ...
     * {@link OpportunityNotification }
     * 
     * 
     */
    public List<OpportunityNotification> getNotification() {
        if (notification == null) {
            notification = new ArrayList<OpportunityNotification>();
        }
